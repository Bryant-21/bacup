...
OBJECTIVE_CASES: dict[str, tuple[int, ...]] = {
    "Fragments:Quests:QF_W05_MQS_202P_Acrobat_003F28C7": (
        10, 50, 51, 100, 75, 150, 200, 201, 202, 210, 211, 225, 250, 251,
        275, 300, 500, 600, 700, 720, 721, 725, 726, 727, 730, 746, 747,
        748, 749, 750, 751, 752, 800, 851, 899, 900, 999, 9000, 9999, 10000,
    ),
