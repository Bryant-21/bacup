...
SCRIPT_NAME = "Objects:BeehiveContainerScript"
...
def test_beehive_container_patch_loads_and_merges_cleanly():
    patch = _script_patch_source(SCRIPT_NAME)
...
def test_beehive_container_patch_merges_and_compiles_for_fo4():
