...
# Deterministic one-shot guarded handler (no named states/timers/quest chain) —
# a full compile of the merged patch is sufficient coverage; see
# repair-papyrus-stubs SKILL.md's dedicated-test-file criteria.
PATCH_CASES = {
    "BoS01TrainingCampNoteScript": {"onread"},
}
