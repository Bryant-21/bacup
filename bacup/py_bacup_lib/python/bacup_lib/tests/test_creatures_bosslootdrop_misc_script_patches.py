...
SCRIPT_NAME = "Creatures:BossLootDrop"
...
def test_boss_loot_drop_patch_supplies_oneffectstart_and_merges_cleanly():
    patch = _script_patch_source(SCRIPT_NAME)
...
def test_boss_loot_drop_patch_set_native_compiles_for_fo4():
