...
SCRIPT_NAME = "Creatures:FestiveGiftAddItem"
...
def test_festive_gift_add_item_patch_supplies_oneffectstart_and_merges_cleanly():
    patch = _script_patch_source(SCRIPT_NAME)
...
def test_festive_gift_add_item_patch_set_native_compiles_for_fo4():
