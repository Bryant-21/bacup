...
SCRIPT_NAME = "DefaultCommunityDepositActivator"
EXPECTED_MEMBERS = {"onactivate"}
...
def test_community_deposit_patch_supplies_onactivate_and_merges_cleanly():
    patch = _script_patch_source(SCRIPT_NAME)
...
def test_community_deposit_patch_set_native_compiles_for_fo4():
