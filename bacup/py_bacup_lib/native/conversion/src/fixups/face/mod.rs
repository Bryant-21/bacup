...
//! - `flatten_nested_traits_lvlns` (top-level Fixup, registered)
//! - `materialize_leveled_template_npcs` (top-level Fixup, registered)
//! - `filter_lchar_template_npcs` (legacy drop pass, unregistered)
